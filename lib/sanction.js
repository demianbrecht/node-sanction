...
Client.prototype = {
    authUri: function CLIENT_authUri(opts, cb) {
        var q = {
    ...
    requestToken: function CLIENT_requestToken(opts, cb) {
        var o = {
    ...
    request: function CLIENT_request(opts, cb) {
    ...
    _request: function CLIENT__request(opts, cb) {
        var o = {
            method: opts.method || 'GET',
...
var transport = {
    ...
    // RFC 6749 doesn't define anything other than "Bearer" for
